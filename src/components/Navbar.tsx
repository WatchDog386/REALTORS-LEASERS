...
const Navbar = () => {
  ...
  return (
    <div className={`fixed top-0 w-full z-50 bg-white transition-all duration-300 ${isScrolled ? "shadow-md" : ""} risa-font`}>
      ...
      {/* Main Nav Bar - REDUCED PADDING (py-2) to fix gap */}
          ...
          <div className="flex flex-col lg:flex-row lg:items-center gap-2 lg:gap-6">
            ...
            <div className="flex items-center justify-between w-full lg:w-auto">
              <div className="flex items-center gap-3">
                ...
                {/* LOGO - Slightly smaller height for sleek look */}
                <div 
                  onClick={handleHomeClick} 
                  className="shrink-0 cursor-pointer flex items-center gap-2.5"
                >
                  <svg viewBox="0 0 200 200" className="h-9 md:h-10 w-auto drop-shadow-sm" xmlns="http://www.w3.org/2000/svg">
                    <defs>
            ...
            {/* Desktop Filter - Slightly smaller height */}
            <button 
              onClick={() => setMenuOpen(true)}
              className="hidden lg:flex flex-col items-start justify-center px-4 h-10 border border-gray-200 hover:border-[#F96302] hover:shadow-sm transition-all bg-gray-50 rounded-xl"
            >
              <span className="text-[9px] text-gray-600 font-bold uppercase mb-0.5 risa-uppercase">Filter</span>
              <span className="text-[13px] font-black text-[#222] flex items-center gap-2 risa-heading">
            ...
            <div className="flex-1 w-full relative">
              <div className="w-full flex items-center bg-white border border-gray-300 rounded-full overflow-hidden pl-1 pr-1 py-0.5 transition-all duration-300 focus-within:border-[#F96302] focus-within:shadow-[0_4px_12px_rgba(0,0,0,0.08)]">
                <div className="relative flex-1">
                  ...
                  <input 
                    ...
                    className="w-full h-9 pl-10 pr-4 border-none outline-none text-sm placeholder:text-gray-400 font-medium bg-transparent risa-body"
                  />
                </div>
                <button className="bg-[#F96302] hover:bg-[#d15200] text-white px-5 md:px-6 h-9 font-black uppercase tracking-tighter transition-all duration-300 rounded-full shadow-sm flex items-center gap-2 risa-heading risa-uppercase">
            ...
            <div className="hidden lg:flex items-center gap-6 shrink-0">
              ...
              <button className="flex items-center gap-2 group relative">
                <div className="relative">
                  <FaShoppingCart size={24} className="text-gray-600 group-hover:text-[#F96302] transition-colors" />
                  {cart.count > 0 && (
